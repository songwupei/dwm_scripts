...
two() {
	...
	xrandr --output $INNER_PORT --mode 1920x1080 --pos 1920x320 --scale 1x1 \
...
oneOutMonitor() {
	xrandr --output $OUTORT1 --mode 1920x1080 --pos 0x0 --scale 1x1 --primary
